...
to a UA that checks prefixes case-sensitively, it will accept this cookie, and
...
sends the following `Set-Cookie` header field for the site to a UA that checks
